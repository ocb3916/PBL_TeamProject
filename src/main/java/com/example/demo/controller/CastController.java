...
public class CastController {
    ...
    public List<Cast> getCastsByMovie(@PathVariable Integer movieId) {
    ...
    public List<Cast> getCastsByMovieAndActor(@PathVariable Integer movieId, @PathVariable Integer actorId) {
        Movie movie = new Movie();
        movie.setId(movieId);
        Actor actor = new Actor();
        actor.setId(actorId);
