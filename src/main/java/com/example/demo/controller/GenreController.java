...
public class GenreController {
    ...
    public List<Genre> getGenresByMovie(@PathVariable Integer movieId) {
    ...
    public List<Genre> getGenresByMovieAndGenreList(@PathVariable Integer movieId, @PathVariable Integer genreListId) {
        Movie movie = new Movie();
        movie.setId(movieId);
        GenreList genreList = new GenreList();
        genreList.setId(genreListId);
