...
public class StreamingSiteController {
    ...
    public List<StreamingSite> getStreamingSitesByMovie(@PathVariable Integer movieId) {
    ...
    public List<StreamingSite> getStreamingSitesBySiteAndMovie(@PathVariable Integer siteId, @PathVariable Integer movieId) {
        StreamingSiteList streamingSiteList = new StreamingSiteList();
        streamingSiteList.setId(siteId);
        Movie movie = new Movie();
        movie.setId(movieId);
